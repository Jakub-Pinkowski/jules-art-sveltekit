<div class="p-4 text-justify">
	<h2 class="my-8 pl-4 text-3xl font-medium md:my-4">Cookie Policy for Jules-Art</h2>
	<div class="p-4">
		<p>This is the Cookie Policy for Jules-Art, accessible from jules-art.com</p>

		<h3 class="my-8 text-xl font-medium md:my-4">What Are Cookies</h3>
		...
		<h3 class="my-8 text-xl font-medium md:my-4">How We Use Cookies</h3>
		...
		<h3 class="my-8 text-xl font-medium md:my-4">Disabling Cookies</h3>
		...
		<h3 class="my-8 text-xl font-medium md:my-4">The Cookies We Set</h3>
		...
		<h3 class="my-8 text-xl font-medium md:my-4">Third Party Cookies</h3>
		...
		<h3 class="my-8 text-xl font-medium md:my-4">More Information</h3>
		...
		<p>
			...
			enabled in case it does interact with one of the features you use on our site. For more
			general information on cookies, please read <a
				class="text-blue-500"
		...
		<p>
			...
			our preferred contact methods. By visiting this link, at the bottom of the page via contact
			form jules-art.com
		</p>
	</div>
</div>
